...
If you are looking for an optimized, and heavely tested C++ machine learning library with a great community, I would recommend [mlpack](https://mlpack.org/), [dlib](http://dlib.net/), [TensorFlow C++ API](https://www.tensorflow.org/api_docs/cc), [Caffe](https://caffe.berkeleyvision.org/) or [PyTorch C++ API](https://pytorch.org/cppdocs/).
